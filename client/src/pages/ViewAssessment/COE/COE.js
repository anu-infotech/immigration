...
import { addCOEDocument, addDocument, deleteDocument } from "../../../actions/assessment";
import { renderInput } from "../../../renderInputs";
import "./style.css";

const COE = ({ handleSubmit, addCOEDocument, assessment, deleteDocument }) => {
