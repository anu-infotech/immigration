...
import { editWorkExperience } from "../../../actions/assessment";
      ...
      >
        ...
        <form
          onSubmit={handleSubmit(async (data) => {
            setAdding(true);
            await editWorkExperience(assessment.ref_no, data, initialValues._id);
            setAdding(false);
            closeModal();
          })}
          style={{ width: "100%" }}
        >
          <Row style={{ marginTop: "30px" }}>
            <Col sm={12}>
              <Widget
                customDropDown
                title={<p className={"fw-bold"}>Edit Work Experience</p>}
              >
