...
class AllVisas extends React.Component {
          ...
          options: {
            ...
            customBodyRender: (value, tableMeta) => {
              const assessment = this.props.assessments.find(
                (assessment) => assessment.ref_no == tableMeta.rowData[5]
              );
              return (
                <div>
                  <Link to={`/app/view-assessment/${tableMeta.rowData[5]}`}>
